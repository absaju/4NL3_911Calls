...
`baseline_models.ipynb` file contains two baseline models. It also contains code to get started with the challenge. For the baselines we have used two models, one using Majority Baseline and the next using logistic regression. The models have achieved an accuracy of 0.40 and 0.59 respectively. Your challenge is to beat these baseline models.
